...
def create_complete_data():
    ...
    lesson_sections = [
        ...
        },
        {
            ...
            'side': 'right',
            'type': 'explanation',
            'content': '基本概念\nC言語は1972年に開発されたプログラミング言語です。\nシステムプログラミングの基盤となる重要な言語で、多くの現代的言語に影響を与えています。',
    ...
    quiz_questions = [
        ...
        },
        {
            ...
            'correct_answer': 1,
            'explanation': 'C言語の配列は0から始まります。最初の要素は arr[0] でアクセスします。',
            'kawada_correct_message': '川田、その通りです！配列は0から始まるんです😊',
            'kawada_wrong_message': '川田、配列のインデックスは何から始まるか思い出してみてください。',
