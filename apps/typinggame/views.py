...
def index(request):
    ...
    questions_data = [
        ...
        {'id': 2, 'japanese': 'エンタープライズ発進', 'romaji': 'entaapuraizuhasshin'},
        {'id': 3, 'japanese': '俺がガンダムだ', 'romaji': 'oregagandamuda'},
        {'id': 4, 'japanese': 'これがシュタインズゲートの選択だよ', 'romaji': 'koregashutainzugeentonosentakudayo'},
        ...
        {'id': 12, 'japanese': 'チャーハン作るよ!', 'romaji': 'chaahantsukunayo!'},
        {'id': 13, 'japanese': 'コーヒーブレイク', 'romaji': 'koohiibureiku'},
        {'id': 14, 'japanese': 'メールアドレス', 'romaji': 'meeruadoresu'},
