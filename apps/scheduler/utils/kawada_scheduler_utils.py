...
class KawadaSchedulerManager:
    ...
    def generate_invitation_message(self):
        ...
        if days_since_last is None:
            ...
            return {
                'title': '川田からの再会のお誘い🌸',
                'content': '1週間ぶりくらいでしょうか？元気にしていましたか？今度の週末、一緒にタイピングゲームで指慣らしはいかがでしょう？',
                'expression': 'thinking',
            ...
            return {
                'title': '川田からの心配のお誘い💔',
                'content': 'お久しぶりです...忙しかったのでしょうか？無理をしなくても大丈夫です。気が向いた時に、軽いChatLessonからはじめませんか？',
                'expression': 'sad',
    ...
    def create_schedule_confirmation_message(self, schedule):
        ...
        KawadaMessage.objects.create(
            ...
            title=f'💕 {date_str}のお約束',
            content=f'わあ！{date_str}に{app_display}のお勉強ですね！とても楽しみです💕 川田もしっかり準備しておきますね！',
